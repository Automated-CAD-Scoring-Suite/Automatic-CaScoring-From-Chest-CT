...
class CaScoreModule(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.contributors = ["Abdullah Alrefaey (SBME, CUFE)", "Ahmed Abdelmageed (SBME, CUFE)",
                                    "Ahmed Mahdy (SBME, CUFE)", "Ahmed Salah (SBME, CUFE)"]  # replace with "Firstname Lastname (Organization)"
...
class CaScoreModuleWidget(ScriptedLoadableModuleWidget):
...
class CaScoreModuleLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self, volumeNode1, volumeNode2, rulerNode):
        ...
        """
        print('CaScoreModuleLogic run() called')
...
class CaScoreModuleTest(ScriptedLoadableModuleTest):
    ...
    def test_CaScoreModule1(self):
        ...
        moduleWidget = slicer.modules.CaScoreModuleWidget
